...
/* xxx } */
	...
	public function getConvos() {
		...
		foreach ($convos as $username) {
			...
			$return_string .= "<a href='messages.php?u=$username'> <div class='user_found_messages'>
													<img src='" . $user_found_obj->getProfilePic() . "' style='border-radious: 5px; margin-right: 5px;'>
	...
	public function getConvosDropdown($data, $limit) {
		...
		$count = 1;//Number of message sposted.

		foreach ($convos as $username) {

				if($num_iterations++ < $start) {
					continue;
				}// if the number of iterations has not reached a srart yet - continue;
				...
				$style = ($row['opened'] == 'no') ? "background-color: #DDEDFF;" : "";//if the message has not been read, put a new nackground to it, otherwise dont do anything.
